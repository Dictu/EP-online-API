...
|	23 apr 2024	|	1.21 |	Paul Kamps		|	Business Rule CheckSurveyDate toegevoegd. Hoofdstuk '2.7. Controle op de actie' aangepast.
...
### 2.6. Controle op recenter registratie
Voor elk gebouw wordt gecontroleerd dat er niet al een recenter registratie aanwezig is op basis van het gevonden adres van het verblijfsobject via de BAG (in geval van identificatie d.m.v. BAG identificatie) of ProvisionalId in Projectgegevens (in geval van identificatie d.m.v. Provisional identificatie).
...
|  Actie  			|	Status									|  Rule(s)
|:------------------|:------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|	Toevoegen	|	<ul><li>Vergunningsaanvraag</li><li>Oplevering</li><li>Bestaand</li></ul>	|<ul><li> Op de opnamedatum (SurveyDate) dient voor geen enkele van de opnameadressen al een registratie te zijn met dezelfde scope en gebouwklasse.</li><li> Toevoegen voor de status ‘Vergunningsaanvraag’ kan enkele één van de blokken ‘BAGIdentification’ of ‘ProvisionalIdentification’ gekozen worden. </li><li> Toevoegen voor de status ‘Vergunningsaanvraag’ is het niet mogelijk om te registreren met een ‘provisionalid’. </li><li> Toevoegen voor woningbouw met een detailaanduiding mag alleen met rechten. Deze kunt u aanvragen in EP-Online. </li></ul>
|	Vervangen		|	<ul><li>Vergunningsaanvraag</li><li>Oplevering</li><li>Bestaand</li></ul>	|	<ul><li>Op de opnamedatum (SurveyDate) dient er al een registratie te zijn met dezelfde scope en gebouwklasse, waarbij alle adressen overeen komen met de initiële registratie.</li><li>Vervangen mag alleen wanneer de rekenmethodiek versie overeen komt met de versie die gebruikt is in de initiële registratie.</li><li>Vervangen mag niet wanneer een of meer van de gebouwen binnen de registratie ingetrokken is.</li><li>Vervangen kan alleen gedaan worden door de registratieadviseur die de initiële registratie heeft gedaan.</li><li>Vervangen van status ‘Vergunningsaanvraag’ kan zonder rechten gedaan worden binnen 60 dagen vanaf de originele registratiedatum. Hierna zijn rechten nodig. Deze kunt u aanvragen in EP-Online.</li><li>Vervangen van status ‘Oplevering’ of status ‘Bestaand’ kan zonder rechten gedaan worden binnen 7 dagen vanaf de originele registratiedatum. Hierna zijn rechten nodig. Deze kunt u aanvragen in EP-Online.</li></ul>
|	Uitbreiden		|	<ul><li>Oplevering</li><li>Bestaand</li></ul>		|	<ul><li> Op de opnamedatum (SurveyDate) dient er al een registratie te zijn met dezelfde scope en gebouwklasse, waarbij alle adressen overeen komen met de initiële registratie.</li><li> Uitbreiden mag alleen wanneer de meeste recente rekenmethodiek versie wordt gebruikt.</li><li> Uitbreiden mag alleen wanneer de rekenmethodiek versie overeen komt met de versie die gebruikt is in de initiële registratie.</li><li> Uitbreiden mag alleen voor status ‘Oplevering’ en status ‘Bestaand’. </li><li> Uitbreiden mag aleen wanneer de adressen waarmee uitgebreid wordt/worden nog geen recentere registratie hebben. </li><li> Uitbreiden voor woningbouw met een detailaanduiding mag alleen met rechten. Deze kunt u aanvragen in EP-Online. </li></ul> 
|	Herlabelen		|	<ul><li>Oplevering</li><li>Bestaand</li></ul>		|	<ul><li>Op de opnamedatum (SurveyDate) dient er al een registratie te zijn met dezelfde scope en gebouwklasse, waarbij alle adressen overeen komen met de initiële registratie.</li><li>De opnamedatum van de te herlabelen registratie mag niet afwijken van de opnamedatum van de initiële registratie.</li><li>Herlabelen mag alleen wanneer de rekenmethodiek versie overeen komt met de versie die gebruikt is in de initiële registratie.</li><li>Herlabelen mag niet wanneer een of meer van de gebouwen binnen de registratie ingetrokken is.</li><li>Herlabelen is alleen mogelijk met rechten. Deze kunt u aanvragen in EP-Online.</li><li>Herlabelen kan alleen binnen dezelfde certificaathouder die gebruikt is in de initiële registratie.</li><li>Herlabelen kan alleen wanneer de huidige registratieadviseur ‘detailinformatie energielabels inzichtelijk’ aan heeft staan in EP-Online.</li><li>Herlabelen kan alleen binnen 24 maanden vanaf de opnamedatum.</li></ul> |
